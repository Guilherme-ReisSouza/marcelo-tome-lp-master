                            ...
                            >
                                ...
                                <SwiperSlide>
                                    <SpecialityCard
                                        ...
                                        description="Contratações indevidas, indenizações, golpes e fraudes."
                                    />
                                </SwiperSlide>
                                ...
                                <SwiperSlide>
                                    <SpecialityCard
                                        ...
                                        description="Consultoria empresarial abrangente, orientação em contratos, gestão de riscos trabalhistas e tributários."
                                    />
                                </SwiperSlide>
                            </Swiper>
                        </MDBCol>
                            ...
                            >
                                <SwiperSlide>
                                    <FeedbackCard
                                        name="Pessoa"
                                        job="Trabalho"
                                        description="Seu filho tem direito a pensão alimentícia, não lutar por esse direito é negligência. Lute pelo seu filho, entre em contato e descubra que é menos complicado do que você pensa."
                                    />
                                </SwiperSlide>
                                <SwiperSlide>
                                    <FeedbackCard
                                        name="Pessoa"
                                        job="Trabalho"
                                        description="A pensão atrasou? Você precisa cobrar antes que seja tarde demais! Trabalho com cobrança de pensão alimentícia pelo rito da execução, ou seja, com bloqueio de contas bancárias e penhora de bens, e também cobrança pelo rito da prisão."
                                    />
                                </SwiperSlide>
                                <SwiperSlide>
                                    <FeedbackCard
                                        name="Pessoa"
                                        job="Trabalho"
                                        description="Conviver com o filho é um direito dos pais, mas também é um direito dos filhos. Se os pais não chegarem a um acordo, deve-se propor uma ação judicial para que o juiz determine e imponha como deve ser."
                                    />
                                </SwiperSlide>
                                <SwiperSlide>
                                    <FeedbackCard
                                        name="Pessoa"
                                        job="Trabalho"
                                        description="Muitas mulheres são reféns de seus companheiros, têm medo de pedir divórcio pois são vítimas de violência doméstica. Reaja! É possível obter uma medida protetiva e garantir sua segurança."
                                    />
                                </SwiperSlide>
                                <SwiperSlide>
                                    <FeedbackCard
                                        name="Pessoa"
                                        job="Trabalho"
                                        description="Faço divórcio e dissolução de união estável, judicial e extrajudicial. Dar o primeiro passo e assumir a ofensiva é fundamental para defender seus interesses. Não perca tempo, entre em contato!"
                                    />
                                </SwiperSlide>
                                <SwiperSlide>
                                    <FeedbackCard
                                        name="Pessoa"
                                        job="Trabalho"
                                        description="Contratações indevidas podem ter como causa um golpe ou uma fraude, nesses casos é possível reaver os valores perdidos, cancelar empréstimos e compras no cartão de crédito, fazer estornos e muito mais."
                                    />
                                </SwiperSlide>
                            </Swiper>
                        </MDBCol>
