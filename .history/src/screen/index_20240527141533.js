                    ...
                    <MDBRow>
                        ...
                        <MDBCol md={9}>
                            ...
                            >
                                ...
                                <SwiperSlide>
                                    <SpecialityCard
                                        speciality="Cobrança de Pensão Atrasada"
                                        description="A pensão atrasou? Você precisa cobrar antes que seja tarde demais! Trabalho com cobrança de pensão alimentícia pelo rito da execução, ou seja, com bloqueio de contas bancárias e penhora de bens (carro, moto, iphone, ect.), e também cobrança pelo rito da prisão, ou seja, ou paga ou é preso! Entre em contato, é simples, rápido e fácil."
                                    />
                                </SwiperSlide>
                                <SwiperSlide>
                                    <SpecialityCard
                                        speciality="Guarda e visitas"
                                        description="Atualmente os termos guarda e visitas não são mais usados, atualmente o correto é falar “regime de convivência”. Conviver com o filho é um direito dos pais, mas também é um direito dos filhos. Contudo, a convivência “não é bagunça não”, se os pais não chegarem a um acordo de como será, deve-se propor uma ação judicial para que o juiz determine e imponha como deve ser. Entre em contato e garanta que seja da melhor forma para você e seu filho."
                                    />
                                </SwiperSlide>
                                <SwiperSlide>
                                    <SpecialityCard
                                        speciality="Obtenção de Medida Protetiva"
                                        description="Muitas mulheres são reféns de seus companheiros, têm medo de pedir divórcio pois são vítimas de violência doméstica. Reaja! É possível obter uma medida protetiva e garantir sua segurança e tempo suficiente para que você tome todas as medidas para se manter segura e viver sua vida. Entre em contato, esse é o primeiro passo para sair dessa vida."
                                    />
                                </SwiperSlide>
                            </Swiper>
                        </MDBCol>
