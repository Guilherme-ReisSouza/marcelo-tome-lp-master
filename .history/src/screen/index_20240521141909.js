                    ...
                    <MDBCol md={6} className='hero-left'>
                        ...
                        <MDBRow className='hero-left-description'>
                            <MDBCol md={9} >
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                    Curabitur a sagittis magna. Nunc dui dolor, commodo sed libero a, pellentesque hendrerit elit.
                                </p>
                            </MDBCol>
                    ...
                    <MDBRow>
                        ...
                        <MDBCol md={9}>
                            ...
                            >
                                ...
                                <SwiperSlide>
                                    <SpecialityCard
                                        speciality="Especialidade 2"
                                        description="There are  of Lorem Ipsum available, but the majority have su alteration in some form, by injected oir  which don't look even slightly believable."
                                    />
                                </SwiperSlide>
                                <SwiperSlide>
                                    <SpecialityCard
                                        speciality="Especialidade 3"
                                        description="There are  of Lorem Ipsum available, but the majority have su alteration in some form, by injected oir  which don't look even slightly believable."
                                    />
                                </SwiperSlide>
                                <SwiperSlide>
                                    <SpecialityCard
                                        speciality="Especialidade 4"
                                        description="There are  of Lorem Ipsum available, but the majority have su alteration in some form, by injected oir  which don't look even slightly believable."
                                    />
                                </SwiperSlide>
                            </Swiper>
