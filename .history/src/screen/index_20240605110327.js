    ...
    >
        ...
        <SwiperSlide>
            <SpecialityCard
                ...
                description="Contratações indevidas, indenizações, problemas com golpes, fraudes financeiras e reclamações bancárias."
            />
        </SwiperSlide>
        ...
        <SwiperSlide>
            <SpecialityCard
                ...
                description="Consultoria empresarial, orientação em contratos e gestão de riscos trabalhistas, tributários e legais."
            />
        </SwiperSlide>
    </Swiper>
</MDBCol>
                    ...
                    <MDBRow className='services-cards' >
                        ...
                        <MDBCol md={4}>
                            <ServicesCard
                                ...
                                description="Evite problemas futuros, tenha sempre um advogado para revisar seus contratos e garantir que todas as cláusulas estejam claras e justas para todas as partes envolvidas, para que seu direito seja revogado."
                            />
                        </MDBCol>
                        <MDBCol md={4}>
                            <ServicesCard
